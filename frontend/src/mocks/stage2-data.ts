...
export function getWorkoutBuilderData(selectedExerciseId = 'group-pullups-1'): WorkoutBuilderData {
  return {
    ...
    groups: [
      {
        ...
        betweenExercisesRest: '120 сек',
        betweenRoundsRest: '120 сек',
        items: [
          { id: 'group-pullups-1', slug: 'machine-pulldown', name: 'Тяга сверху', muscleGroup: 'Спина', muscles: ['Широчайшие', 'Бицепс', 'Предплечья'], sets: '3×10', rest: '120 сек', load: '45 кг', loadType: 'weighted', previewVideoUrl: '/media/exercises/machine-pulldown/male-side.mp4' },
          { id: 'group-squat-1', slug: 'barbell-heels-up-back-squat', name: 'Присед', muscleGroup: 'Ноги', muscles: ['Квадрицепс', 'Ягодицы', 'Бицепс бедра'], sets: '3×8', rest: '120 сек', load: '60 кг', loadType: 'weighted', previewVideoUrl: '/media/exercises/barbell-heels-up-back-squat/male-side.mp4' },
        ],
      },
      {
        id: 'group-b',
        ...
        title: 'Основной блок',
        items: [
          { id: 'row-1', slug: 'machine-seated-cable-row', name: 'Тяга горизонтального блока', muscleGroup: 'Спина', muscles: ['Широчайшие', 'Бицепс', 'Предплечья'], sets: '3×10', rest: '120 сек', load: '45 кг', loadType: 'weighted', previewVideoUrl: '/media/exercises/machine-seated-cable-row/male-side.mp4' },
          { id: 'row-2', slug: 'underhand-pulldown', name: 'Тяга к поясу в тренажёре', muscleGroup: 'Спина', muscles: ['Широчайшие', 'Бицепс', 'Предплечья'], sets: '4×12', rest: '120 сек', load: '40 кг', loadType: 'weighted', previewVideoUrl: '/media/exercises/underhand-pulldown/male-side.mp4' },
          { id: 'curl-1', slug: 'barbell-curl', name: 'Сгибание рук с гантелями', muscleGroup: 'Бицепс', muscles: ['Бицепс', 'Предплечья'], sets: '3×12', rest: '120 сек', load: '20 кг', loadType: 'weighted', previewVideoUrl: '/media/exercises/barbell-curl/male-side.mp4' },
          { id: 'plank-1', slug: 'forearm-plank', name: 'Планка', muscleGroup: 'Кор', muscles: ['Пресс', 'Косые мышцы', 'Плечи'], sets: '3×45 сек', rest: '120 сек', load: 'вес тела', loadType: 'timed', previewVideoUrl: '/media/exercises/forearm-plank/male-side.mp4' },
        ],
      },
    ],
    selectedExerciseId,
    selectedExercise: {
      ...
      strengthPlan: buildStrengthPlan('basic', null, { reps: 10, weight: 45, restSeconds: 120 }, 'weighted'),
    ...
    warnings: [
      ...
      { tone: 'warning', title: 'Короткий отдых', description: 'Для тяжёлых подходов рекомендуется отдых около 120 секунд.' },
